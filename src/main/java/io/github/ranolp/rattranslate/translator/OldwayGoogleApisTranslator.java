...
public class OldwayGoogleApisTranslator implements Translator {
    ...
    private OldwayGoogleApisTranslator() {
    }

    public static OldwayGoogleApisTranslator getInstance() {
    ...
    private String translate(String sentences, String from, String to) {
        ...
        try {
            String url = "https://translate.googleapis.com/translate_a/single?client=gtx&sl=" + from + "&tl=" + to + "&dt=t&q=" + URLEncoder
    ...
    private static final class SingletonHolder {
        private static final OldwayGoogleApisTranslator INSTANCE = new OldwayGoogleApisTranslator();
    }
}
